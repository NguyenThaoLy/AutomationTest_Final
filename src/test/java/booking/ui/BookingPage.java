...
public class BookingPage {
    ...
    public static Target DESTINATION_FIELD = Target.the("destination field")
            .located(By.cssSelector("input.sb-destination__input"));

    public static Target OPPTION_DES = Target.the("choose option search destination")
            .located(By.cssSelector("li[role=\"option\"][data-i =\"0\"]"));
